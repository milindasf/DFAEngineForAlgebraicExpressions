...
public class DFAEngine {
	...
	public DFAEngine(int numOfStates,int numOfSymbols,int indexOfStartingState,int [] indexesOfAcceptingStates,char[] alphabet){
		...
		for(int i=0;i<this.numOfStates;i++){
			for(int j=0;j<this.numOfSymbols;j++){
				transitionMatrix[i][j]=-1; // Initialize all the transitions to -1 at the beginning.
			}			
		}
	...
	public boolean AddTransition(int startStateIndex,char symbol,int endStateIndex){
	...
	public static void main(String[] args) {
		...
		DFAEngine basicAlgebericExpressoion=new DFAEngine(4, 15, 0, acceptingState, alphabet);
